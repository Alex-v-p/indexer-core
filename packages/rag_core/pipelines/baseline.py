...
BASELINE_RAG_CONFIG = PipelineConfig(
    ...
    description="Classify the query, retrieve evidence, strictly validate metadata scope, and generate a citation-aware answer.",
    tool_names=(QUERY_CLASSIFIER_TOOL, BASELINE_RETRIEVER_TOOL, BASELINE_LLM_TOOL),
    metadata={"stages": ("classify_query", "retrieve", "prepare_evidence_context", "generate_answer")},
)
