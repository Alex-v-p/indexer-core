...
HYBRID_RAG_CONFIG = PipelineConfig(
    ...
    description="Dense-vector and BM25 keyword retrieval fused with weighted reciprocal-rank fusion.",
    tool_names=(
...
def build_hybrid_rag_graph(*, retriever: Retriever, llm_provider: LLMProvider) -> GraphRunner:
    """Build the hybrid graph: hybrid retrieve → generate_answer."""
