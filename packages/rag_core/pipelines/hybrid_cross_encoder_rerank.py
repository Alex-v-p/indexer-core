...
from packages.rag_core.agents.shared.retrieval.tracing import evidence_summary, rerank_input_summary
...
from packages.rag_core.agents.shared.retrieval.nodes import RerankNode, RetrieveNode
...
HYBRID_CROSS_ENCODER_RERANK_RAG_VERSION = "0.2.0"
...
HYBRID_CROSS_ENCODER_RERANK_RAG_CONFIG = PipelineConfig(
    ...
    description="Classify the query, run hybrid retrieval, apply a local cross-encoder reranker, and generate an answer.",
    tool_names=(
